        ...
        : query.reason === "signed_out"
          ...
          : query.reason === "signed_out_cleanup_unconfirmed"
            ...
            : query.reason === "all_sessions_revoked"
              ? "You have been signed out of all devices. Already-issued access tokens on another device can remain valid until their encoded expiry. Sign in here to continue."
              : "";
