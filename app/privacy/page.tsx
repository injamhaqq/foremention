...
export default function PrivacyPage() {
  return <PublicShell>
    <section className="page-hero"><div className="shell narrow-heading"><span className="eyebrow">Effective August 18, 2026</span><h1>Privacy</h1><p>This notice explains the product data Foremention processes, why it is needed, and the choices available to account owners.</p></div></section>
    <article className="legal-copy shell">
      ...
      <p>Foremention uses PostHog&apos;s US-hosted cloud service for limited product and web analytics. The integration is configured without session replay, automatic click or form capture, form values, AI-provider answers, citations, or customer evidence. It records page routes and selected product milestones so Foremention can find broken journeys and improve the product. Identified product events, when used, rely on internal account and organization identifiers rather than names or email addresses.</p>
