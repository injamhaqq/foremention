...
export default function PrivacyPage() {
  return <PublicShell>
    ...
    <article className="legal-copy shell">
      ...
      <p>Foremention may use PostHog for limited product and web analytics. The current production integration sends analytics to PostHog&apos;s US ingestion endpoint. It is configured without session replay, automatic click or form capture, form values, AI-provider answers, citations, or customer evidence. It records selected product milestones rather than automatic pageview capture so Foremention can find broken journeys and improve the product. Identified product events use internal account and organization IDs rather than names or email addresses. Google Analytics and Google Tag Manager are not loaded.</p>
