...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [runMultiEngineScan, cleanupCancelledCollection, scheduleWeeklyWorkspaceRuns, discoverAcquisitionTargets, dispatchMeasurementSchedules, runtimeServiceProbe, deliverWorkspaceWebhookEvents, deliverHubSpotActionEvents],
});
