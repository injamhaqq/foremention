  ...
  return <main className="workspace">
    ...
    <section className="panel">
      {existing && viewer.mode !== "demo"
        ...
        : <OnboardingWizard demo={viewer.mode === "demo"} draftKey={`foremention:onboarding:${viewer.id}`} firstAuditProvider={firstAuditProvider ? { id: firstAuditProvider.id, label: firstAuditProvider.label } : null} />}
    </section>
  </main>;
}
