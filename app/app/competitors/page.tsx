...
export default async function CompetitorsPage() {
  ...
  return <main className="workspace"><div className="workspace-heading"><div><span className="eyebrow">Competitive evidence</span><h1>Competitor tracking</h1><p>Compare exact-name appearances across persisted AI answers and human-reviewed cited pages. Foremention reports observations, not market share or causation.</p></div></div><CompetitorTracker initial={competitors} canManage={viewer.mode === "demo" || role !== "viewer"} demo={viewer.mode === "demo"} /></main>;
}
