...
import { loadRunAnswers, loadRunConfiguration, loadRunCostEvents, loadRuns } from "@/lib/data";
...
export default async function RunDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [runs, answers, costEvents, configuration] = await Promise.all([loadRuns(viewer), loadRunAnswers(viewer, id), loadRunCostEvents(viewer, id), loadRunConfiguration(viewer, id)]);
