...
export default async function SettingsPage() {
  ...
  return <main className="workspace">
    ...
    <div className="settings-grid">
      ...
      <section className="panel"><span className="eyebrow">Plan and billing</span><h2>{FREE_BETA_LIMITS.plan} workspace</h2><dl className="settings-list"><div><dt>Plan state</dt><dd>Founder access</dd></div><div><dt>Billing</dt><dd>Not connected</dd></div><div><dt>Brands</dt><dd>{FREE_BETA_LIMITS.brands}</dd></div><div><dt>Collection capacity</dt><dd>{FREE_BETA_LIMITS.runUnitsPerMonth} observations / month</dd></div><div><dt>History</dt><dd>{FREE_BETA_LIMITS.historyDays} days</dd></div></dl><p className="table-caption">No card is charged and no paid entitlement is activated until a verified billing webhook is connected.</p></section>
