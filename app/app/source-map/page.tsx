...
export default async function SourceMapPage() {
  ...
  return <main className="workspace" data-product-state={state}>
    ...
    <section className="panel panel--flush" id="source-review-queue">
      ...
      {entries.length ? <>
        ...
        <div id="source-table"><LazySourceMapTable entries={entries} canEdit={canEdit} demo={viewer.mode === "demo"} /></div>
