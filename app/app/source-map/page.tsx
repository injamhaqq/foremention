...
export default async function SourceMapPage() {
  ...
  return <main className="workspace">
    ...
    <div className="workspace-heading"><div><span className="eyebrow">Evidence</span><h1>Sources</h1><p>See the pages AI systems actually cited in answers about {category}, then review what those pages say and where your brand is missing.</p></div><Link className="button button--ink" data-workspace-export href="/api/export/source-map">Export sources &darr;</Link></div>
