...
export const metadata: Metadata = pageMetadata({ title: "AI Visibility Platform with Source Intelligence", description: "Explore Foremention Source X-Ray, Source Map, Agent Control Plane, Decision Lab, evidence review, buyer-question monitoring, and action tracking.", path: "/product" });
