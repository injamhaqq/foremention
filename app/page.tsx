...
export default function HomePage() {
  ...
  return <PublicShell>
    ...
    <section className="home-pricing-section" id="pricing"><div className="shell"><div className="platform-heading"><span className="goat-kicker">Built to compound</span><h2>Infrastructure your team can grow into.</h2><p>Start with one category, then add questions, brands, collection capacity, history, and integrations as the intelligence layer becomes part of your operating system.</p></div><div className="home-pricing-grid"><article><span>Core</span><strong>$149<small>/month</small></strong><p>One category, a durable Source Map, and monthly evidence collection.</p><Link href="/pricing">Explore Core <Arrow /></Link></article><article className="is-featured"><span>Signal</span><strong>$499<small>/month</small></strong><p>Weekly collection, competitive movement, and collaboration for growth teams.</p><Link href="/pricing">Explore Signal <Arrow /></Link></article><article><span>Intelligence</span><strong>Scale<small> with your category</small></strong><p>Multi-brand monitoring, deeper history, API access, and custom capacity.</p><Link href="/pricing">View platform plans <Arrow /></Link></article></div></div></section>
