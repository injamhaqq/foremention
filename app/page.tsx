...
const faq = [
  ...
  { q: "Can I try the product for free?", a: "Yes. The free beta has one brand, up to 10 buyer questions, 20 provider-prompt observations per month, and 90 days of history. No credit card is required." },
];
...
export default function HomePage() {
  ...
  return (
    <PublicShell>
      ...
      <section className="home-pricing-section" id="pricing"><div className="shell"><div className="platform-heading"><span className="goat-kicker">Start with evidence</span><h2>One clear beta. Useful limits. No hidden spend.</h2><p>Foremention is product infrastructure, not a placement package. The beta is free while the live provider and billing connections are introduced carefully.</p></div><div className="home-pricing-grid"><article><span>Free beta</span><strong>$0<small>/month</small></strong><p>1 brand, 10 buyer questions, 20 provider-prompt observations, and 90 days of history.</p><Link href="/signup">Create free account <Arrow /></Link></article><article className="is-featured"><span>Product demo</span><strong>Try it<small> safely</small></strong><p>Explore the complete workflow with clearly labelled fictional data. No API key or card required.</p><Link href="/login">Open demo <Arrow /></Link></article><article><span>What comes next</span><strong>Scale<small> when ready</small></strong><p>More engines, history, automation, and team access arrive only after billing and provider controls are verified.</p><Link href="/pricing">See beta limits <Arrow /></Link></article></div></div></section>
