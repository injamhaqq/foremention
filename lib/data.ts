...
export function getProviderStatuses(): ProviderStatus[] {
  const statuses: ProviderStatus[] = [
    ...
    { id: "cloudflare", label: "Cloudflare Workers AI + Browser Run", configured: Boolean(cloudflareAiConfigured() && getProviderCostRates("cloudflare")), supportsCitations: true, health: "untested", latestStatus: null, lastTestedAt: null, verifiedAnswers: 0, presencePct: null },
