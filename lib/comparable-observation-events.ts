...
/**
 * Turns the already-selected exact comparable pair into customer-readable events.
 * This function does not choose which runs are comparable. That decision remains
 * owned by loadWeeklyIntelligence, which gates on question/provider/exact-model/
 * methodology parity before it exposes a previous run.
 */
