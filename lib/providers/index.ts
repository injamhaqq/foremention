...
const providers: Record<ProviderId, AnswerProviderAdapter> = { openai: openAIAdapter, gemini: geminiAdapter, anthropic: anthropicAdapter, perplexity: perplexityAdapter, mock: mockAdapter };
