# Public category and canonical Record Markdown interoperability — September 26, 2026

This change extends existing valid /index.md, /product.md and /methodology.md coverage to Foremention's two central public intellectual-property explanations.

- /recommendation-record.md follows the existing page's eight record fields and five-stage returned/retrieved/observed/reviewed/safe-conclusion model.
- /recommendation-intelligence.md follows the existing category page's distinctions from SEO/GEO/AEO/rank-tracking/general AI visibility.
