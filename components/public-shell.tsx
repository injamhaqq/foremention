...
export function PublicFooter() {
  return <footer className="public-footer"><div className="shell footer-grid"><div><Wordmark inverse /><p className="footer-note">Recommendation intelligence for B2B software. Inspect what AI-mediated buyers were shown, what evidence came back, and what can safely be acted on.</p><a className="footer-email" href="mailto:hello@foremention.com">hello@foremention.com</a></div><div className="footer-links"><div><span>Product</span><Link href="/product">Product</Link><Link href="/source-map">Evidence</Link><Link href="/methodology">Methodology</Link><Link href="/pricing">Pricing</Link><Link href="/standards">Standards</Link></div><div><span>Company</span><Link href="/about">About</Link><Link href="/insights">Research</Link><Link href="/contact">Request a demo</Link></div><div><span>Legal / Trust</span><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/subprocessors">Subprocessors</Link><ExperienceAnalyticsPreferences /></div><div><span>Access</span><Link href="/login">Sign in</Link><Link href="/signup">Create workspace</Link><a href="https://www.linkedin.com/company/foremention/" target="_blank" rel="noreferrer">LinkedIn</a><a href="https://www.instagram.com/forementionhq/" target="_blank" rel="noreferrer">Instagram</a></div></div></div><div className="shell footer-bottom"><span>&copy; {new Date().getFullYear()} Foremention</span><span>Register. Prove. Prepare.</span></div></footer>;
}
