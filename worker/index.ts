...
const contentSecurityPolicy = [
  ...
  "object-src 'none'",
  "script-src 'self' 'unsafe-inline' https://*.posthog.com https://*.contentsquare.net https://*.clarity.ms https://c.bing.com https://static.cloudflareinsights.com",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' data: https://fonts.gstatic.com",
  "img-src 'self' data: https:",
  "connect-src 'self' https://*.supabase.co https://*.ingest.sentry.io https://*.posthog.com https://*.contentsquare.net https://*.contentsquare.com https://*.clarity.ms https://c.bing.com https://cloudflareinsights.com",
  "frame-src 'self' https://csxd.contentsquare.net",
  "manifest-src 'self'",
...
async function handleVisibilityScore(request: Request, env: Env) {
  ...
  const result = {
    ...
    provider: "Cloudflare Workers AI + Bing Search RSS",
