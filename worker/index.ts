...
const contentSecurityPolicy = [
  ...
  "object-src 'none'",
  "script-src 'self' 'unsafe-inline' https://*.posthog.com https://*.contentsquare.net",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' data: https://fonts.gstatic.com",
  "img-src 'self' data: https:",
  "connect-src 'self' https://*.supabase.co https://*.ingest.sentry.io https://*.posthog.com https://*.contentsquare.net https://*.contentsquare.com",
